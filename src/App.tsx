...
const translations = {
  en: {
    ...
    aboutMe: "About Me",
    aboutP1: "I received my M.S. degree in telecommunications from the <strong>Slovak University of Technology in Bratislava (STU)</strong> in 2021, where I successfully completed my Ph.D. degree.",
  ...
  sk: {
    ...
    aboutMe: "O mne",
    aboutP1: "Inžiniersky titul (Ing.) v odbore telekomunikácie som získal na <strong>Slovenskej technickej univerzite v Bratislave (STU)</strong> v roku 2021, kde som následne úspešne ukončil doktorandské štúdium a získal titul PhD.",
